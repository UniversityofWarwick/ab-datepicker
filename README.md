...
|clientValidation      |Whether to apply HTML client-side form validation to prevent form submission when an invalid date is typed manually.|true|clientValidation: false|
...
|fontAwesomePro		   |Set to true to use Font Awesome Pro instead of Free. Requires fontAwesome:true, and an FA Pro license.|false|fontAwesomePro: true |
...
|noMinutesOutsideHourRange |Hide minute increments after the maxHour provided.|false|noMinutesOutsideHourRange: true|
